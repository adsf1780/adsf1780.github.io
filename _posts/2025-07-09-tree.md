...
- **degree(노드의 차수)**: 바로 밑에 연결된 child node의 개수
  - degree of A = 2
  - degree of E = 1
  - degree of J = 0
...
- depth $ \approx $ height다.
- depth와 heigt의 차이: depth는 위에서부터 0이고, height는 밑에서부터 0이다.
...
![](\assets\images\2025-07-09-tree\image28.png){: .align-center}
